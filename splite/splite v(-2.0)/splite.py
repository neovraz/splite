...
def home_scrdraw1():
    ...
    home_Display.blit(pygame.transform.scale(cont,(325,100)),(233,100))
def home_scrdraw2():
    cont_sel=pygame.image.load("Continue_sel.bmp")
    home_Display.blit(pygame.transform.scale(cont_sel,(325,100)),(233,100))
def home_scrdraw3():
    new=pygame.image.load("newgame.bmp")
    home_Display.blit(pygame.transform.scale(new,(325,100)),(233,300))

def home_scrdraw4():
    new_sel=pygame.image.load("newgame_sel.bmp")
    home_Display.blit(pygame.transform.scale(new_sel,(325,100)),(233,300))

def home_scrdraw5():
    _quit=pygame.image.load("quit.bmp")
    home_Display.blit(pygame.transform.scale(_quit,(154,100)),(233,500))

def home_scrdraw6():
    quit_sel=pygame.image.load("quit_sel.bmp")
    home_Display.blit(pygame.transform.scale(quit_sel,(154,100)),(233,500))
...
def gapause():
    gameDisplay.blit(pygame.transform.scale(pause,(800,400)),(200,200))
    pygame.display.flip()
    while not end:
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_q or homexit==True and event.key == pygame.K_c:
                    home_scr()
                    game_pause=False
                    end=False
                if event.key == pygame.K_c:
...
def game():
    ...
    q_pause = pygame.image.load("q_pause.png")
    ...
    game_pause=True                                #Variable for pausing the game
